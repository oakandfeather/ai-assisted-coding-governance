...
**Owner:** *(repo owner / team)* · **Version:** 1.1 · **Last reviewed:** *(date)* · **Active client:** *(client name)*
...
**Work the way [`agent-workflow.md`](./ai-governance/agent-workflow.md) describes** (work loop, ask-vs-proceed boundary, verification, structured hand-off, bounded iteration and adversarial self-review), and for code apply the engineering-quality patterns in [`coding-patterns.md`](./ai-governance/coding-patterns.md). Where craft meets safety, safety and correctness win.
