...
**Version:** 2.2 · **Last reviewed:** 2026-08-05 · **Review cycle:** Quarterly, or whenever a client's AI terms change.
...
*(When a change also ships documentation — a README, API reference, runbook, or release note — that documentation is a written deliverable: [`writing-rules.md`](./writing-rules.md) governs its risks — §6 in particular, which requires you to actually run any command or snippet you document — and [`writing-patterns.md`](./writing-patterns.md) §4 its craft. This file governs the code the documentation describes.)*
