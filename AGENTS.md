...
**Owner:** *(your company)* — Engineering · **Version:** 1.2 · **Last reviewed:** 2026-07-26 · **Active client:** none (internal repository)
...
**Work the way [`agent-workflow.md`](./ai-docs/agent-workflow.md) describes** (work loop, ask-vs-proceed boundary, verification, structured hand-off, bounded iteration and adversarial self-review), and for code apply the engineering-quality patterns in [`coding-patterns.md`](./ai-docs/coding-patterns.md). Where craft meets safety, safety and correctness win.
