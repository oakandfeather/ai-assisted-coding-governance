...
**Version:** 1.0 · **Last reviewed:** 2026-09-06 · **Status:** **Proposed, not implemented** · **Review cycle:** None; revisit when `core-rules.md` §5 is next edited.
...
> - **Other repositories on this machine are not your workspace.** A developer's disk commonly holds several engagements at once. Don't read, copy, or import from another project's repository to solve a problem in this one — not for a pattern, a config, or a snippet — and don't write outside the repository you were pointed at. If something there would genuinely help, name it and ask; carrying one client's material into another client's work is a confidentiality breach whatever the size of the fragment.
>
